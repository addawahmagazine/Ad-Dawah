...
/* -------------------------------------------------------------------------
   ...
   ধাপ ১ — Netlify → Project configuration → Environment variables
           তিনটি যোগ করুন:
             ...
             TG_CHAT_ID      = টেলিগ্রাম গ্রুপের আইডি (মাইনাসসহ)
             TG_HOOK_SECRET  = নিজের বানানো যেকোনো গোপন শব্দ

           সতর্কতা: এই তিনটি মান কখনো কোনো ফাইলে লিখবেন না।
           রিপোজিটরি সবার জন্য খোলা, আর Netlify ফাইলে এগুলো পেলে
           নিরাপত্তার জন্য ডিপ্লয় আটকে দেয়।
